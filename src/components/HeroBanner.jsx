...
const HeroBanner = () => {
  ...
  const banners = [
    ...
    },
    {
      ...
      subtitle:
        'আমাদের বিশেষজ্ঞ টিম সর্বদা আপনার সেবায় নিয়োজিত। যেকোনো সমস্যার তাৎক্ষণিক সমাধান',
    ...
    },
    {
      ...
      subtitle:
        'হাই কমিশন, বোনাস এবং দীর্ঘমেয়াদী আয়ের সুযোগ। আমাদের সাথে যুক্ত হয়ে আপনার ভবিষ্যৎ গড়ুন',
